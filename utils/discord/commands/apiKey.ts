...
export const apiKeyCommand = {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        if (subcommand === 'create') {
            await handleCreateApiKey(interaction)
        } else if (subcommand === 'list') {
            await handleListApiKeys(interaction)
        } else if (subcommand === 'delete') {
            await handleDeleteApiKey(interaction)
        }
    },
} satisfies DiscordCommand

async function handleCreateApiKey(interaction: ChatInputCommandInteraction) {
...
async function handleListApiKeys(interaction: ChatInputCommandInteraction) {
    try {
